...
import com.darthorg.bozo.manager.PrefManager;
...
public class Welcome extends AppCompatActivity {
    ...
    private void addBottomDots(int currentPage) {
        ...
        int[] colorsActive = getResources().getIntArray(R.array.array_welcome_dot_ativo);
        int[] colorsInactive = getResources().getIntArray(R.array.array_welcome_dot_inativo);
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(Welcome.this, Inicio.class));
        finish();
    }
